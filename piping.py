...
# ==========================================
# 3. TOP RIBBON: GLOBAL PARAMETERS
# ==========================================
...
# ==========================================
# 9. ENTERPRISE OPEX & ECONOMICS ENGINE
# ==========================================
st.markdown("---")
...
with eco_col:
    with st.container(border=True):
        st.markdown("<div style='color: #2563eb; font-weight: 700; margin-bottom: 10px; text-transform: uppercase; font-size: 0.85rem; letter-spacing: 1px;'>Power Economics</div>", unsafe_allow_html=True)
        ...
        st.markdown(f"**Annual Operating Cost:** <span style='color:#ef4444; font-weight:bold;'>${annual_cost:,.2f}</span>", unsafe_allow_html=True)
        st.markdown(f"**10-Year Lifecycle Cost:** <span style='color:#ef4444; font-weight:bold;'>${ten_year_cost:,.2f}</span>", unsafe_allow_html=True)

with safety_col:
    with st.container(border=True):
        st.markdown("<div style='color: #2563eb; font-weight: 700; margin-bottom: 10px; text-transform: uppercase; font-size: 0.85rem; letter-spacing: 1px;'>System Diagnostics</div>", unsafe_allow_html=True)
...
report_text = f"""
=========================================
HYDRACALC ENTERPRISE - SYSTEM REPORT
=========================================
FLUID PROPERTIES:
Fluid: {fluid_choice}
Density: {rho} kg/m3
...
st.download_button(
    ...
    data=report_text,
    file_name="HydraCalc_Enterprise_Report.txt",
    mime="text/plain",
